...
Gem::Specification.new do |s|
  ...
  s.files = ["Rakefile", "CHANGELOG.rdoc", "README.rdoc", "bin/tweetwine", "lib/tweetwine", "lib/tweetwine/client.rb", "lib/tweetwine/config.rb", "lib/tweetwine/util.rb", "lib/tweetwine.rb"]
  s.has_rdoc = true
  s.homepage = %q{http://github.com/tuomas/tweetwine}
  s.rdoc_options = ["--title", "Tweetwine 0.1.0", "--main", "README.rdoc", "--exclude", "spec", "--line-numbers"]
  s.require_paths = ["lib"]
