...
Gem::Specification.new do |s|
  ...
  s.files = ["Rakefile", "CHANGELOG.rdoc", "README.rdoc", "bin/tweetwine", "lib/tweetwine", "lib/tweetwine/client.rb", "lib/tweetwine/io.rb", "lib/tweetwine/options.rb", "lib/tweetwine/rest_client_wrapper.rb", "lib/tweetwine/startup_config.rb", "lib/tweetwine/url_shortener.rb", "lib/tweetwine/util.rb", "lib/tweetwine.rb", "test/client_test.rb", "test/io_test.rb", "test/options_test.rb", "test/rest_client_wrapper_test.rb", "test/startup_config_test.rb", "test/test_config.yaml", "test/test_helper.rb", "test/url_shortener_test.rb", "test/util_test.rb"]
  s.homepage = %q{http://github.com/tuomas/tweetwine}
  s.rdoc_options = ["--title", "Tweetwine 0.2.0", "--main", "README.rdoc", "--exclude", "test", "--line-numbers"]
  s.require_paths = ["lib"]
